...
- **Set-jump keymap**: a dedicated key per override set that jumps directly to it from anywhere, independent of the currently active set — flight only, since it targets a live vessel's own state.
