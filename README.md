...
- Extended axes are driven by controller axes only: there is no keyboard or mouse-wheel "stepped" source for them yet (stock's own +/- keys remain available on the four stock custom axes).
